...
const ROLE_PERMISSIONS = {
    veterinario: {
        pages: ['patient', 'addpet', 'recording', 'soap', 'nutrition', 'soap-readonly', 'owner', 'history', 'diary', 'settings', 'debug', 'costs', 'document', 'vitals', 'photos', 'medications', 'tips', 'communication', 'ai-petdesc', 'shared-records', 'teleconsult', 'diagnostics', 'preventive-care', 'marketplace'],
    ...
    proprietario: {
        pages: ['patient', 'addpet', 'nutrition', 'diary', 'vitals', 'medications', 'history', 'soap-readonly', 'owner', 'photos', 'tips', 'settings', 'debug', 'document', 'costs', 'communication', 'ai-petdesc', 'vaccination-calendar', 'preventive-care', 'marketplace'],
    ...
    admin_brand: {
        pages: ['admin-dashboard', 'admin-catalog', 'admin-campaigns', 'admin-wizard', 'settings', 'marketplace'],
        actions: ['manage_catalog', 'manage_campaigns', 'view_dashboard', 'export_reports', 'run_wizard']
    },
    vet_int: {
        pages: ['patient', 'addpet', 'recording', 'soap', 'nutrition', 'soap-readonly', 'owner', 'history', 'diary', 'settings', 'debug', 'costs', 'document', 'vitals', 'photos', 'medications', 'tips', 'communication', 'ai-petdesc', 'shared-records', 'teleconsult', 'diagnostics', 'preventive-care', 'education', 'marketplace'],
        actions: ['record', 'transcribe', 'generate_soap', 'archive', 'read_document', 'explain_document', 'export_pdf', 'sync', 'communicate', 'view_shared_records', 'teleconsult', 'view_diagnostics']
    },
    vet_ext: {
        pages: ['patient', 'soap-readonly', 'owner', 'history', 'settings', 'debug', 'document', 'communication', 'shared-records', 'teleconsult', 'diagnostics', 'referral-analytics', 'loyalty', 'preventive-care', 'education', 'marketplace', 'developer'],
        actions: ['view_profile', 'view_history', 'explain_document', 'communicate', 'view_shared_records', 'teleconsult', 'view_diagnostics']
    },
    breeder: {
        pages: ['breeder-dashboard', 'breeder-litters', 'breeder-milestones', 'patient', 'addpet', 'booking', 'nutrition', 'diary', 'vitals', 'medications', 'history', 'owner', 'document', 'communication', 'settings', 'debug', 'ai-petdesc', 'shared-records', 'vaccination-calendar', 'preventive-care', 'genetic-tests', 'marketplace'],
    ...
    super_admin: {
        pages: ['admin-dashboard', 'admin-catalog', 'admin-campaigns', 'admin-wizard',
                ...
                'patient', 'addpet', 'recording', 'soap', 'nutrition', 'soap-readonly', 'owner', 'history', 'diary', 'vitals', 'medications', 'photos', 'tips', 'document', 'costs', 'seed', 'communication', 'ai-petdesc', 'shared-records', 'teleconsult', 'diagnostics', 'marketplace'],
